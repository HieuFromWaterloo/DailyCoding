...
P.S. This algorithm is how the rsync utility is implemented, and was first described here. (https://www.andrew.cmu.edu/course/15-749/READINGS/required/cas/tridgell96.pdf)

It's surprisingly short and easy to read! A few things in the paper that aren't mentioned here:
