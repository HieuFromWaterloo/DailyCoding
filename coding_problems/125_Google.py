...
"""
This question is similar to the two-sum problem with a list. We can actually reduce this problem into that one by turning the tree into a list. To save some space, we'll use
**generators**, which are like list-like but are generated on-the-fly.
"""
