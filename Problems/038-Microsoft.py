...
"""
If you're interested in optimizing this problem even further, check out this paper (backtracking algo) that uses constant space by representing all columns and diagonals simply with integers! However, this depends on n being smaller than the number of bits in your integer.
